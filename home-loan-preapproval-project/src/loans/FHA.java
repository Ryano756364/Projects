...
public class FHA extends LoanSuper implements Loan{

    // *** FIELDS ***
    private final double MAX_DTI = 57.00;  // 57% max for conventional
    ...
    // *** CONSTRUCTORS ***
    public FHA () {};
    public FHA(int maxLoanLimit, int minLoanLimit, double maxDTI, String creditScore) {
